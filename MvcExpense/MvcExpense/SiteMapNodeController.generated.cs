...
namespace MvcExpense.UI.Controllers {
    public partial class SiteMapNodeController {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SiteMapNodeController Actions { get { return MVC.SiteMapNode; } }
        ...
        public class ViewNames {
            public readonly string ChangeChildrenOrder = "~/Views/SiteMapNode/ChangeChildrenOrder.cshtml";
            public readonly string Create = "~/Views/SiteMapNode/Create.cshtml";
            public readonly string Delete = "~/Views/SiteMapNode/Delete.cshtml";
            public readonly string Edit = "~/Views/SiteMapNode/Edit.cshtml";
            public readonly string List = "~/Views/SiteMapNode/List.cshtml";
            public readonly string Tree = "~/Views/SiteMapNode/Tree.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_SiteMapNodeController: MvcExpense.UI.Controllers.SiteMapNodeController {
        ...
        public override System.Web.Mvc.ActionResult Create(MvcExpense.UI.Models.Input.SiteMapNodeCreateInput input) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Create);
        ...
        public override System.Web.Mvc.ActionResult Edit(MvcExpense.UI.Models.Input.SiteMapNodeEditInput input) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Edit);
            callInfo.RouteValueDictionary.Add("input", input);
            return callInfo;
        }
