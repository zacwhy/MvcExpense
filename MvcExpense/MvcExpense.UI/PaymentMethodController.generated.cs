...
namespace MvcExpense.UI.Controllers {
    public partial class PaymentMethodController {
        ...
        public class ViewNames {
            ...
            public readonly string Index = "~/Views/PaymentMethod/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_PaymentMethodController: MvcExpense.UI.Controllers.PaymentMethodController {
        ...
        public override System.Web.Mvc.ActionResult Create(MvcExpense.Core.Models.PaymentMethod model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Create);
        ...
        public override System.Web.Mvc.ActionResult Edit(MvcExpense.ViewModels.PaymentMethodEditModel editModel) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Edit);
            callInfo.RouteValueDictionary.Add("editModel", editModel);
            return callInfo;
        }
